...
public class KonsumentenkreditPos_Controller implements Initializable, ControlledScreen {
	...
	@FXML
	TextField tf_konsumgut;

//	@FXML Button bt_speichern;
//	@FXML Button zurueck;
	...
	public void bt_speichernClicked() throws IOException {
		...
		aPosition.setTilgungsrate(Double.valueOf((tf_tilgungsrate.getText())));}
			...
			System.out.println("Ungueltige Eingabe");
		aPosition.setKonsumgut(tf_konsumgut.getText());
